$(document).ready(function() {
    ...
    $("#login").submit((e) => {
        const baseUrl = "https://ryanwilliamharper.com/online_shop/api/routes/auth.php";        
        clearDiv($("#err-div"));
    ...
    $("#register").submit((e) => {
        const baseUrl = "https://ryanwilliamharper.com/online_shop/api/routes/users.php";
        e.preventDefault();
        clearDiv($("#err-div"));
    ...
    $("#logout-btn").on("click", (e) => {
        ...
        .done(function(data = JSON.parse(`{ "message": ${data.message} }'`)) {
            ...
            const elementsToHide = [$("#logout-btn"), $("#nav-icons span"), $("#portalBtn"), $("#wishlistBtn")];
